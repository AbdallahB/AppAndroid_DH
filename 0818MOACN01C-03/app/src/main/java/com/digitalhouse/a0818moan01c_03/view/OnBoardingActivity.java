...
public class OnBoardingActivity extends AppCompatActivity {
    ...
    public static final String PREFRENCES_ON = "preferencesOn";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        preferences = getSharedPreferences(PREFRENCES_ON, MODE_PRIVATE);
        flag = preferences.getBoolean(FLAG, false);

        if (!flag) {

            btnSkip = findViewById(R.id.footer_control_button_skip);
            btnFinish = findViewById(R.id.footer_control_button_finish);
            ...
            btnNext.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (v.getId() == R.id.footer_control_button_next) {
                        page++;
            ...
            btnFinish.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    getSharedPreferences(OnBoardingActivity.PREFRENCES_ON, MODE_PRIVATE).edit().putBoolean(OnBoardingActivity.FLAG, true).apply();
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            int[] images = {R.drawable.musica, R.drawable.handshake2, R.drawable.registrate};
            int[] label = {R.string.genero, R.string.busqueda, R.string.registrate};
            imageView.setImageResource(images[sectNumb]);
            textView.setText(label[sectNumb]);
